...
<div class="login-form" style="width: 600px">
    <form action="<?= base_url() ?>kelompok/kelompokRegist" method="POST" enctype="multipart/form-data">
        <div class="top">
            ...
            <h1>Selamat Datang Kelompok Baru<br> Registrasi akun anda berhasil<br>Admin akan mengkonfirmasi akun dalam kurun waktu 1 x 15 menit </h1>
            <h4>Riau Pos Intermedia</h4>
        </div>

        <div class="form-area">

            <a href="<?= base_url() ?>kelompok/" class="btn btn-default btn-block">login</a>
        </div>
