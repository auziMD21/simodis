...
<div class="login-form">
    <form action="<?= base_url() ?>kelompok/kelompokLogin" method="POST">
        <div class="top">
    ...
    <div class="footer-links row">
        <div class="col-xs-6"><a href="<?= base_url() ?>kelompok/daftar"><i class="fa fa-external-link"></i> Register Now</a></div>
    </div>
</div>
